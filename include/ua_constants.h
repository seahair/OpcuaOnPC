...
/**
* @file ua_constants.h
* @Synopsis  通用的UA变量，包括状态码UA_StatusCode等不变的通用变量
* @author BeckOS
* @version V1.1.0
* @date 2018-05-04
*/
...
#ifndef UA_CONSTANTS_H__
#define UA_CONSTANTS_H__
#ifdef __cplusplus
extern "C"
{
#endif
	...
	/* --------------------------------------------------------------------------*/
	/**
	 * @Synopsis  OPCUA协议标准中定义的attribute类型,UA信息模型中的节点属性由节点类型决定，所有的类型可能性如下：
	 */
	/* ----------------------------------------------------------------------------*/
	typedef enum {
